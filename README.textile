...
*ap* is a program that help regular users to organize and manage their
...
*ap* permits to start or stop a Apache daemon for each web site using
...
h2. Copyright, license and disclaimer

Copyright (c) 2011 "creativ-IT":http://creativ-it.net
